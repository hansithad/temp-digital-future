...
export const mobileapp1 = {
  ...
  title:'Predictable time and cost',
  subtitle:'Having the hands-on digital expertise we can provide with accurate predictability of timelines and costs of digital related projects.',
  data:[
    'Define full expenses of the project ahead of time.',
    'Define the timelines of delivery ahead of time.',
    "Easily start and stop projects with our Managed Services to reduce the cost of piloting your digital initiatives.",
    'DF will provide the full setup for the team: Resident Visas, office space, Dubai Internet City EP.',
  ]};

export const mobileapp2 = {
  label:'MANAGED SERVICES',
  title:'Agile Digital Transformation',
  subtitle:'Adding our employees as an outsourced project management workforce reduces the burden of scaling your inhouse digital teams.',
  data:[
    'Building the team from our pool of employees allows rapid project setup.',
    "Adding a specialized talent with our Sourcing Service allows us to deliver even highly specialized projects.",
    "Flexibly adjust the scope of work according to your current needs.",
    'Easily take the projects back to your organization once out of the pilot phase.',
  ]};
